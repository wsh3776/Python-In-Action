# Project: https://github.com/CharlesPikachu/Games
# Puzzle Skill: https://www.zhihu.com/question/21350363
# Puzzle Skill: https://www.zhihu.com/question/22547591
"""
原则：一列一列还原，每列从上往下还原，2X2是基础，借助3X3复原 多利用2X2旋转的功能
Principle: restore one column at a time, each column is restored from top to bottom, 2X2 is the foundation using 3X3. Make the most of 2X2 rotation
"""
import os
import sys
import random
...
def main():
    ...
    screen = pygame.display.set_mode(
        (game_img_used_rect.width, game_img_used_rect.height))
