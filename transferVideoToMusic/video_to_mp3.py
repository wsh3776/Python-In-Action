...
print(1 == 2)
# filepath：待处理视频的文件路径
filepath = "/Users/macos/Documents/Wilson79/GitHub/Python-In-Action/transferVideoToMusic/video/"
...
output_dir = "/Users/macos/Documents/Wilson79/GitHub/Python-In-Action/transferVideoToMusic/music/"
...
for i in range(len(filename)):
    ...
    change_postfix_name = filename[i].replace(
        'mp4', 'mp3').replace('flv', 'mp3')  # 另外的视频格式请自行添加
